...
public class QuizService {
    ...
    public void selfPacedQuiz(String userName) {
        ...
        Collections.shuffle(questions); // shuffle the ordered question
        ...
        displaySummary(userName, quizType, correctAnswer, attempted, total, percentage);
    ...
    private void displaySummary(String userName, String quizType, int correct, int attempted, int total, float percentage) {
        System.out.println();
        System.out.println("===================================");
